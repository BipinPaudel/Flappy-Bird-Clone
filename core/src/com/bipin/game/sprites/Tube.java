package com.bipin.game.sprites;
...
/**
 * Created by bips on 5/18/16.
 */
public class Tube {
    public static final int TUBE_WIDTH=52;
    private static final int FLUCTUATION=170;//can move up and down randomly from 0 to 130
    private static final int TUBE_GAP=100;//difference in the opening in the tube
